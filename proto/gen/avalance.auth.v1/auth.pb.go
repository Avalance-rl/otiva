...
func (x *ValidationResponse) Reset() {
	*x = ValidationResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_contracts_auth_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ValidationResponse) Descriptor() ([]byte, []int) {
	return file_contracts_auth_proto_rawDescGZIP(), []int{4}
}
...
var file_contracts_auth_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x24, 0x0a, 0x0c, 0x54, 0x6f, 0x6b,
	0x65, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22,
	0x43, 0x0a, 0x12, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73,
	...
	0x65, 0x72, 0x49, 0x64, 0x32, 0xba, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72,
	...
	0x75, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x31, 0x0a,
	...
	0x12, 0x3f, 0x0a, 0x0d, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x54, 0x6f, 0x6b, 0x65,
	0x6e, 0x12, 0x12, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x56, 0x61, 0x6c,
	0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x00, 0x42, 0x19, 0x5a, 0x17, 0x61, 0x76, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x61, 0x75,
...
var file_contracts_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_contracts_auth_proto_depIdxs = []int32{
	...
	3, // 2: auth.AuthService.ValidateToken:input_type -> auth.TokenRequest
	2, // 3: auth.AuthService.Register:output_type -> auth.AuthResponse
	2, // 4: auth.AuthService.Login:output_type -> auth.AuthResponse
	4, // 5: auth.AuthService.ValidateToken:output_type -> auth.ValidationResponse
...
func file_contracts_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_contracts_auth_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_contracts_auth_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_contracts_auth_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_contracts_auth_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_contracts_auth_proto_msgTypes[4].Exporter = func(v any, i int) any {
